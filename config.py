...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002404193775"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "6474680825"))

#Port
PORT = os.environ.get("PORT", "7374")

#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://Obito_space:<Rohitta5145C>@cluster0.2sejq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "Cluster0")

#force sub channel id, if you want enable force sub
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1001846180235"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002141491340"))
FORCESUB_CHANNEL3 = int(os.environ.get("FORCESUB_CHANNEL3", "-1001771621542"))
